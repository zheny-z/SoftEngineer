...
# os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'acss_site.settings')
...
def create_order(request_type: PileType,
    ...
    order = Order.objects.create(begin_time=begin_time, end_time=end_time, create_time=get_datetime_now(),
                                 total_cost=costs[0], charging_cost=costs[1], service_cost=costs[2],
                                 charged_amount=amount, charged_time=(end_time - begin_time).seconds,
                                 pile=pile, user=user)
