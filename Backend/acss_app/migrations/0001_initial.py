# Generated by Django 4.0.4 on 2023-06-05 13:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pile_type', models.IntegerField(choices=[(0, 'Charge'), (1, 'Fast Charge')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pile', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='acss_app.pile')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='acss_app.user')),
            ],
        ),
    ]
